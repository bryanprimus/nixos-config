...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "bryan"
    user-mail-address "bryantobing0@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bryan/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bryan/bin" "/profile/bin" "/Users/bryan/.npm-packages/bin" "/Users/bryan/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
